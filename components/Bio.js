   ...
   return (
      ...
      <h1><span className={bioStyles.bioTitle}>About</span></h1>
         <span className={bioStyles.bioContent}>
            ...
            after that I moved to London/Uk and I became Bartender after livin' 4 years in that beautiful city I've moved to Marseille where I'm since 2014, I have 2 little girls Charlie and Ana-Luisa,
            I'm 32 years old and I've been creating websites for about 2 years now!
